// programs here are the working after choosing ticket, 
//also the functionalities about ticket choosing then procceding to ticket purchasing and keeping neccesary information of user in database.
